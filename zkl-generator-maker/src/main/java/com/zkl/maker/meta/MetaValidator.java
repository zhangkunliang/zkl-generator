...
import com.zkl.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "zkl");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.zkl");
